    ...
    Friend Class Program
        ...
        Public Shared Sub ApplySignatures()
            ...
            Using signer = New PdfDocumentSigner("Document.pdf")
                ...
                Dim pkcs7Signature As Pkcs7Signer = New Pkcs7Signer("Signing Documents/certificate.pfx", "123", PdfHashAlgorithm.SHA256, tsaClient, Nothing, Nothing, PdfSignatureProfile.PAdES_BES)
                ...
                'Specify an image and signer information
                santuzzaSignature.SetImageData(IO.File.ReadAllBytes("Signing Documents/SantuzzaValentina.jpg"))
